...
public class HindustanTimes_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hindustan_activity);
...
//            Toast.makeText(this,"Welcome", Toast.LENGTH_SHORT).show();
        ...
        intent_to_prajavani.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, PrajaVaani_MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        intent_to_vijayavaani.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, VijayaVaani_MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        intent_to_vijayakarnataka.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, VijayaKarnataka_MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        intent_to_udayavaani.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, UdayaVaani_MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        intent_to_suvarna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                card_clicked = getResources().getString(R.string.toolbar_title_home_an);
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, AsiaNet_MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        intent_to_esanje.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, Esanje_MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        intent_to_deccan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, DeccanHerald_Activiy.class);
                startActivity(intent);
            }
        });
        ...
        intent_to_allTerms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFirebaseAnalytics.logEvent(card_clicked, params);
                Intent intent = new Intent(HindustanTimes_Activity.this, All_Terms_MainActivity.class);
                startActivity(intent);
            }
        });
