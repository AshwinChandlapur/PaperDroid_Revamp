 ...
 */
public class Tab6_Entertainment_DNA extends Fragment {

    private final String tag = Constants.dna_entertainment;//TODO:Should Change Accordingly
    private View view;
    private Context context;

    public Tab6_Entertainment_DNA() {
