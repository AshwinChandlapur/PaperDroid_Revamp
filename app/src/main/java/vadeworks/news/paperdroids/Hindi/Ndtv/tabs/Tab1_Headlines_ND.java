 ...
 */
public class Tab1_Headlines_ND extends Fragment {

    private final String tag = Constants.nd_headlines;
    private Context context;
    private View view;


    public Tab1_Headlines_ND() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsIcon.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.ndtv));
        init(view);
