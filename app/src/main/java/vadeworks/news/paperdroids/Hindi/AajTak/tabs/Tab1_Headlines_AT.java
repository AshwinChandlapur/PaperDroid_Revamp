 ...
 */
public class Tab1_Headlines_AT extends Fragment {

    private final String tag = Constants.at_headlines;
    private Context context;
    private View view;


    public Tab1_Headlines_AT() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsIcon.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.aajtak));
        init(view);
