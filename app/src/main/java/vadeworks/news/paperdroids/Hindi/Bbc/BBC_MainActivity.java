package vadeworks.news.paperdroids.Hindi.Bbc;
...
import vadeworks.news.paperdroids.Hindi.Bbc.tabs.ViewPagerAdapter_BBC;
...
public class BBC_MainActivity extends AppCompatActivity {

    private final CharSequence[] Titles = {"  खबर  ", "  देश  ", "  दुनिया  ", "  खेल  ", "  मनोरंजन  "};
    private final int Numboftabs = 5;
    private Toolbar toolbar;
    private ViewPager pager;
    private ViewPagerAdapter_BBC adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        utils.onClickers(this, mDrawerLayout, Constants.bbc);
    ...
    private void init_slider() {
        ...
        adapter = new ViewPagerAdapter_BBC(getSupportFragmentManager(), Titles, Numboftabs);
    ...
    private void init_navigator() {
        ...
        getSupportActionBar().setTitle(R.string.toolbar_title_home_bbc);
    }

    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(BBC_MainActivity.this, MainScreen_Activity.class);
