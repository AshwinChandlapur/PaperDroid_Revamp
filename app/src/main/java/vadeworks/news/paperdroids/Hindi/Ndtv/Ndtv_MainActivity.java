package vadeworks.news.paperdroids.Hindi.Ndtv;
...
import vadeworks.news.paperdroids.Hindi.Ndtv.tabs.ViewPagerAdapter_ND;
...
public class Ndtv_MainActivity extends AppCompatActivity {
    ...
    private ViewPagerAdapter_ND adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        utils.onClickers(this, mDrawerLayout, Constants.ndtv);
    ...
    private void init_slider() {
        ...
        adapter = new ViewPagerAdapter_ND(getSupportFragmentManager(), Titles, Numboftabs);
    ...
    private void init_navigator() {
        ...
        getSupportActionBar().setTitle(R.string.toolbar_title_home_ndtv);
    }

    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(Ndtv_MainActivity.this, MainScreen_Activity.class);
