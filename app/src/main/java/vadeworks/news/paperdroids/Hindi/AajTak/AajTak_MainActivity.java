package vadeworks.news.paperdroids.Hindi.AajTak;
...
import vadeworks.news.paperdroids.Hindi.AajTak.tabs.ViewPagerAdapter_AT;
...
public class AajTak_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        utils.onClickers(this, mDrawerLayout, Constants.at);
    ...
    private void init_navigator() {
        ...
        getSupportActionBar().setTitle(R.string.toolbar_title_home_aajtak);
    }

    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(AajTak_MainActivity.this, MainScreen_Activity.class);
