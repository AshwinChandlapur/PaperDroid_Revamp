 ...
 */
public class Tab1_Headlines_BBC extends Fragment {

    private final String tag = Constants.bbc_headlines;
    private Context context;
    private View view;


    public Tab1_Headlines_BBC() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsIcon.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.bbc));
        init(view);
