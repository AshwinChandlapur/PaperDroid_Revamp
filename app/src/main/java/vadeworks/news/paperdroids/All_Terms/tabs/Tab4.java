...
public class Tab4 extends Fragment {
    ...
    private final String Disclaimer ="Disclaimer\n" +
            ...
            "News Duniya does not own any of the content provided here. The content provided here is used under fair use policy and News Duniya would like to credit the original content creators and does'nt intend to infringe copyright."+
            ...
            "Through this app you are able to link to other apps which are not under the control of NEWS DUNIYA. We have no control over the nature, content and availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.\n" +
            "Every effort is made to keep the app up and running smoothly. However,NEWS DUNIYA takes no responsibility for, and will not be liable for, the app being temporarily unavailable due to technical issues beyond our control.";
